...
export const SkeletonPhoto = () => {
  return (
    <div className="flex justify-between min-w-full">
      <div
        role="status"
        className="w-full mx-4 p-4 border border-gray-700 rounded shadow animate-pulse md:p-12 dark:border-gray-700 my-2"
      >
        <div className="flex items-center justify-center h-64 mb-4 bg-gray-300 rounded dark:bg-gray-700">
          <svg
            className="w-40 h-16 text-gray-200 dark:text-gray-600"
            aria-hidden="true"
